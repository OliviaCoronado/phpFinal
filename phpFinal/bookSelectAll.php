<?php 
session_start();
//pass the selected book id as a GET parameter on the url
...
<head>
    <title>Select All for Page</title>
    ...
    ?>
            ...
            <button><a href='deleteBook.php?bookId=<?php echo $row["book_Id"];?>'> Delete</a></button>                         
            </div>
